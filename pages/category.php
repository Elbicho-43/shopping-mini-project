...
$selectedCategory = isset($_GET['type']) ? $_GET['type'] : "";
...
<html>
<head>
    <title><?php echo $shopName; ?> - <?php echo $selectedCategory != "" ? $selectedCategory : "Jerseys"; ?></title>
...
<body>
    ...
    <section class="products" style="padding-top: 50px;">
        ...
        <h2><?php echo $selectedCategory != "" ? $selectedCategory : "All Jerseys"; ?></h2>

        <p class="section-text">
            Showing <?php echo count($categoryProducts); ?> jersey(s) in this category.
        </p>
        ...
        <div class="product-container">
            ...
            <?php if (count($categoryProducts) == 0) { ?>
                <p style="text-align:center; grid-column: 1 / -1;">
                    No jerseys found in this category yet. Check back soon!
                </p>
            <?php } ?>
            ...
            <?php foreach ($categoryProducts as $product) { ?>
                ...
                <div class="product-card">
                    ...
                    <div class="product-details">
                        ...
                        <a href="product.php" class="view-button">View Details</a>
                    </div>
